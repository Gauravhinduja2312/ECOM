  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-8">
      <div className="grid gap-8 md:grid-cols-2">
        ...
        <div>
          <label className="text-[10px] font-black uppercase tracking-widest text-slate-500 mb-4 block">Phone Number</label>
          <input 
            value={phone} 
      ...
      <div>
        <label className="text-[10px] font-black uppercase tracking-widest text-slate-500 mb-4 block">Email Address (Read-only)</label>
        <input 
          disabled 
          value={profile?.email || ''} 
          className="elite-input opacity-50 cursor-not-allowed" 
        />
      </div>
      <button 
        disabled={loading} 
        className="btn-elite w-full py-5 text-[10px] tracking-[0.2em]"
      >
...
export default function UserDashboardPage() {
  ...
  return (
    <div className="bg-[#020617] min-h-screen pt-48 pb-20 stagger-elite">
        ...
        <header className="mb-20 grid lg:grid-cols-12 gap-10 items-end">
          <div className="lg:col-span-8">
            ...
            <h1 className="text-6xl md:text-8xl font-black tracking-tight leading-[0.8] mb-6 text-white truncate uppercase">
              ...
              <span className="text-indigo-400">{profile.full_name || profile.email?.split('@')[0]}</span>
            </h1>
          ...
          {activeTab === 'profile' && (
            <div className="mx-auto max-w-2xl">
              <div className="glass-card p-12">
                <h3 className="text-4xl font-black text-white tracking-tighter uppercase mb-2">Edit Profile</h3>
                <p className="text-slate-500 text-[10px] font-black uppercase tracking-[0.2em] mb-12">Update your personal identification</p>
